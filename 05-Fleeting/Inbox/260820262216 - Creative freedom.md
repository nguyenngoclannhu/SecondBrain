...
> "You can do anything" but if only you let that happen only by **what your mind "knows"**, a very small portion of the multiverse -> limit the miracle. To live "I can do anything" kind of life then you need to ==let go of the "how"==, cause that is the surprise. It is not our job to figure it out
