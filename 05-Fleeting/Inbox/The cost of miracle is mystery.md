...
- Then there is the idea of other people. They are always said that people meant to bring you down with them. And by not focusing on the "how" and only the goal, you silenced out all the friction. Not only the you have a clear picture of where you are heading but also limit the obstacles that get in your way. I think that what's the finding easier. Cause when you are not blocked by y
