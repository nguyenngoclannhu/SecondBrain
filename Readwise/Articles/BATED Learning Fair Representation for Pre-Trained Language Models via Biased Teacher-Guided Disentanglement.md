...
## Full Document
[[Full Document Contents/Articles/BATED Learning Fair Representation for Pre-Trained Language Models via Biased Teacher-Guided Disentanglement.md|See full document content →]]
...
>>>>>>> 87dad16 (readwise)
## Highlights
- to learn fair representation ([View Highlight](https://read.readwise.io/read/01k2k98x8gbd55w63v4qas27qr))
- **B**i**A**sed **TE**acher-guided **D**isentanglement (called **BATED**). ([View Highlight](https://read.readwise.io/read/01k2k98q2ht2703bkhmvhzz6dt))
- biased teacher model rather than relying on sensitive attribute information of the training data. ([View Highlight](https://read.readwise.io/read/01k2kegxpvdtmfty7ra30s4nbx))
- causal contrastive learning ([View Highlight](https://read.readwise.io/read/01k2kehq8fqnezq5bx3zq9h4ps))
- a task-agnostic general biased teacher model. ([View Highlight](https://read.readwise.io/read/01k2kehzfkfdfhr2722gtdjqvp))
- Variational Auto-Encoder (VAE) ([View Highlight](https://read.readwise.io/read/01k2kej9nd25fxesjf3wxse3c3))
- The Biased representation is further decoupled via biased teacher-guided disentanglement, while the fair representation learn downstream tasks. ([View Highlight](https://read.readwise.io/read/01k2ken4wyn7vvytpq311e890n))
